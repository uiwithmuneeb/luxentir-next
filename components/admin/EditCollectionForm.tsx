...
export default function EditCollectionForm({
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!res.ok) {
      setMessage("Collection could not be updated.");
      return;
    }
    ...
    <div className="admin-form-card">
      <div className="admin-panel-head">
        <div>
          ...
          <span>Update curated collection details for Luxentir storefront</span>
        </div>

        <button className="admin-secondary-btn" onClick={() => router.push("/admin/collections")}>
          Back
        </button>
      </div>
      ...
      <form className="admin-product-form" onSubmit={handleSubmit}>
        <div className="admin-form-grid">
          ...
          <div className="admin-field full">
            ...
            {uploading && <p className="admin-form-message">Uploading image...</p>}
        ...
        <div className="admin-form-actions">
          ...
          <button
            ...
            disabled={loading || uploading}
          >
            {loading ? "Updating..." : uploading ? "Uploading..." : "Update Collection"}
          </button>
        </div>
      </form>
    </div>
